...
exports.createRegistration = function (newRegistration, res, callback) {
...
var pending = 0;
exports.findEventRegFromUsername = function (req, res) {
    // Checking if authorized 
...
exports.getParticipants = function (req, res) {
    ...
    EventRegistration.find({ eventId: req.params.eventId }, { _id: 0, __v: 0 }, function (err, eventRegs) {
        ...
        if (eventRegs !== 0) {
            eventRegs.forEach(function (eventRegistration) {
                pending++;
